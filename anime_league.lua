...
create("TextLabel", {
    ...
    BackgroundTransparency=1, Font=FONT_BLACK, Text="ASSET INSPECTOR",
...
local statusLabel = create("TextLabel", {
    ...
    BackgroundTransparency=1, Font=FONT_BOLD, Text="● READY",
...
inspectorTool.Parent = LP:WaitForChild("Backpack")
